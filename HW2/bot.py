...
async def start_command(message: Message):
    ...
    await message.answer(
        ...
        "🤖 <b>Использую:</b> mistralai/mistral-small-3.2-24b-instruct:free\n\n",
...
async def handle_document(message: Message):
    ...
    try:
        ...
        await status_msg.edit_text(
            ...
            f"🤖 <b>Модель:</b> mistralai/mistral-small-3.2-24b-instruct:free"
        )
...
КРИТЕРИИ ОЦЕНКИ (50 баллов максимум):
1. Качество кода и решения (0-10 баллов)
2. Полнота и правильность реализации (0-10 баллов)  
3. Документация и комментарии (0-10 баллов)
4. Оформление и структура работы (0-10 баллов)
5. Качество результатов и выводов работы (0-10 баллов)
...
- Поставь итоговую оценку из 50 баллов
...
async def main():
    ...
    print("🤖 ИИ модель: mistralai/mistral-small-3.2-24b-instruct:free")
